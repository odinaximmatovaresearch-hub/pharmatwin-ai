    ...
    fileFilter:
      (req, file, cb) => {
        ...
        if (
          ...
          cb(
            new Error(
              "Only PDF diploma files are allowed."
            )
          );
        }
      }
...
A clinician has requested access to your health information.
    ...
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            message:
              "Medical diploma PDF is required."
          });
      }
        ...
        .json({
          ...
          message:
            ...
            "clinician"
              ...
              ? "Doctor registration submitted. Diploma verification is required."
  ...
  async (
    ...
    if (
      ...
      return res
        ...
        .json({
          message:
            "Doctor account is waiting for verification."
        });
    }
    ...
    try {
      ...
      try {
        ...
        return res
          ...
          .json({
            message:
              "Consent request created, but SMS delivery failed."
          });
      }
...
app.get(
  ...
  async (
    ...
    try {
      ...
      const response =
        await fetch(
          `https://devsms.uz/api/get_status.php?request_id=${
            encodeURIComponent(
  ...
  (
    ...
    if (
      ...
      return res
        ...
        .json({
          message:
            "Signal type and title are required."
        });
    }
    ...
    res
      ...
      .json({
        ...
        message:
          "Clinical decision-support signal saved."
      });
  }
);
...
app.listen(
  ...
  () => {
    ...
    console.log(
      `PharmaTwin AI API running on port ${PORT}`
    );
  }
);
